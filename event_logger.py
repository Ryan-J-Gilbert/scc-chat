...
class EventLogger:
    ...
    def log_user_message(self, chat_uuid: str, message: str, user: str, tokens: Optional[int] = None) -> int:
    ...
    def log_agent_response(self, chat_uuid: str, response: str, tokens: Optional[int] = None) -> int:
    ...
    def log_tool_call(self, chat_uuid: str, tool_data: Dict[str, Any]) -> int:
        ...
        return self.log_event(
            chat_uuid=chat_uuid,
            event_type=self.TOOL_CALL,
            content=tool_data
        )
    
    def log_retrieval(self, chat_uuid: str, query: str, results: List[Dict[str, Any]]) -> int:
